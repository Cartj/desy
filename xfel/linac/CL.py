...
cl_cfx = Drift(l = 0.1, id = 'cl_cfx')
d6170 = Drift(l = 6.17, id = 'd6170')
cl_chy = Drift(l = 0.2, id = 'cl_chy')
...
cl_chx = Drift(l = 0.2, id = 'cl_chx')
d0490 = Drift(l = 0.49, id = 'd0490')
cl_cfy = Drift(l = 0.1, id = 'cl_cfy')
...
cl_cols = Drift(l = 1.0, id = 'cl_cols')
d2150 = Drift(l = 2.15, id = 'd2150')
d0750 = Drift(l = 0.75, id = 'd0750')
cl_colm = Drift(l = 0.5, id = 'cl_colm')
...
# bending magnets 
cl_be_1 = Bend(l = 2.50000404725, angle = 0.00623326508226, e1 = 0.00311663254113, e2 = 0.00311663254113, tilt = 1.5707963268, id = 'cl_be_1')
cl_bl_1 = Bend(l = 0.200000004527, angle = -0.000737026298601, e1 = -0.000368513149301, e2 = -0.000368513149301, tilt = 1.5707963268, id = 'cl_bl_1')
cl_be_2 = Bend(l = 2.50000391393, angle = -0.00612973992124, e1 = -0.00306486996062, e2 = -0.00306486996062, tilt = 1.5707963268, id = 'cl_be_2')
cl_bl_2 = Bend(l = 0.200000004378, angle = 0.000724781857982, e1 = 0.000362390928991, e2 = 0.000362390928991, tilt = 1.5707963268, id = 'cl_bl_2')
...
# sextupoles 
cl_sa_1 = Sextupole(l = 0.3, k2 = 18.590202663, tilt = 1.5707963268, id = 'cl_sa_1')
cl_sa_2 = Sextupole(l = 0.3, k2 = -15.6304560049, tilt = 1.5707963268, id = 'cl_sa_2')
cl_sa_3 = Sextupole(l = 0.3, k2 = 3.01313108964, tilt = 1.5707963268, id = 'cl_sa_3')
cl_sa_4 = Sextupole(l = 0.3, k2 = -18.590202663, tilt = 1.5707963268, id = 'cl_sa_4')
cl_sa_5 = Sextupole(l = 0.3, k2 = 15.6304560049, tilt = 1.5707963268, id = 'cl_sa_5')
cl_sa_6 = Sextupole(l = 0.3, k2 = -3.01313108964, tilt = 1.5707963268, id = 'cl_sa_6')
